---
title: Architecture
description: "TermUI's architecture: a 15-package monorepo where @termuijs/core handles the screen buffer and render pipeline. Widgets, JSX, store, router, motion, TSS, testing, dev-server, adapters, and charts packages layer on top independently."
---

import { PackageDependencyGraph, RenderPipeline, EventFlow, DevServerFlow } from '@/components/docs/ArchitectureDiagrams'
