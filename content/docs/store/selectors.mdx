---
title: "Selectors & Subscriptions"
description: "Use selectors to scope component re-renders to exactly the state slice they need. Subscribe outside React with store.subscribe() or store.computed()."
---
