...
export const Route = createFileRoute('/components')({
  head: () => ({
    meta: [
      { title: 'Components | TermUI' },
      { name: 'description', content: `${registry.length} terminal UI components — browse by category across widgets, ui, jsx, and tss packages.` },
    ],
    links: [{ rel: 'stylesheet', href: componentsBrowserCss }],
  }),
