---
title: Quick Start
description: Build your first TermUI terminal app in under 5 minutes. Covers App setup, Box and Text widgets, keyboard input handling, and JSX-based components with useState and useEffect.
