---
title: Architecture
description: "TermUI's architecture: a 13-package monorepo where @termuijs/core handles the screen buffer and render pipeline. Widgets, JSX, store, router, motion, TSS, testing, and dev-server packages layer on top independently."
