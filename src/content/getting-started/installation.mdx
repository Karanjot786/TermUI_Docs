---
title: Installation
description: Install TermUI with bunx create-termui-app or add @termuijs/core directly. Requires Bun 1.3+ for development. Published packages run on Node 18+. Includes 13 packages for building TypeScript terminal apps.
