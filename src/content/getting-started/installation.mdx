---
title: Installation
description: Install TermUI with npx create-termui-app or add @termuijs/core directly. Requires Node.js 18+. Supports npm, pnpm, and yarn. Includes 13 packages for building TypeScript terminal apps.
