---
title: "Query Strings"
description: "Pass and read query parameters in your TermUI routes using push(), replace(), and the useQueryParams hook."
...
```ts
import type { QueryParams } from '@termuijs/router'
