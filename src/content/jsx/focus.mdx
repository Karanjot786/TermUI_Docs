...
<thead><tr><th>Option</th><th>Type</th><th>Default</th><th>Description</th></tr></thead>
<tbody>
<tr><td>`items`</td><td>`T[]`</td><td>Required</td><td>The list of items to navigate</td></tr>
<tr><td>`loop`</td><td>`boolean`</td><td>`false`</td><td>Wrap around at list boundaries</td></tr>
<tr><td>`pageSize`</td><td>`number`</td><td>`10`</td><td>How many items `PageUp`/`PageDown` skip</td></tr>
<tr><td>`initialIndex`</td><td>`number`</td><td>`0`</td><td>Starting position</td></tr>
</tbody>
</table>
...
<tr><td>`selectedItem`</td><td>`T`</td><td>The item at `selectedIndex`</td></tr>
<tr><td>`select(index)`</td><td>`(i: number) => void`</td><td>Programmatically jump to an index</td></tr>
</tbody>
</table>
