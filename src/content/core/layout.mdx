...
<tbody>
<tr><td><code>length(n)</code></td><td>Exactly n cells</td></tr>
<tr><td><code>percentage(n)</code></td><td>n% of available space</td></tr>
<tr><td><code>ratio(num, den)</code></td><td>num/den of available space</td></tr>
<tr><td><code>min(n)</code></td><td>At least n cells</td></tr>
<tr><td><code>max(n)</code></td><td>At most n cells</td></tr>
<tr><td><code>fill(weight?)</code></td><td>Fill remaining space. Multiple fill constraints share it by weight</td></tr>
</tbody>
</table>
