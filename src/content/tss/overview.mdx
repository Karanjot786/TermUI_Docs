---
title: "TSS Overview"
description: "Terminal Style Sheets (TSS) bring CSS-like theming to Node.js terminal apps. Define named themes with CSS custom property syntax, write widget selectors with :hover and :focus pseudo-classes, and switch themes at runtime with applyTheme(). Works across all TermUI widgets and components."
