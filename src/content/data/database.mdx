---
title: "Database"
description: "Check database connectivity and connection pool health for Postgres and MySQL via @termuijs/data."
...
```ts
import { database } from '@termuijs/data'
import { usePolling } from '@termuijs/data'
import type { DatabaseConfig, DatabaseHealth } from '@termuijs/data'
