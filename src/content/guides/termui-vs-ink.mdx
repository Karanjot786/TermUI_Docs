---
title: TermUI vs Ink
description: "TermUI vs Ink: a direct comparison of the two TypeScript terminal UI frameworks. Compare theming, routing, state management, animation, hot reload, and testing support."
