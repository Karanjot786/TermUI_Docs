---
title: "What is a TUI?"
description: "A TUI (terminal user interface) is an interactive application that renders a persistent, navigable UI inside a terminal emulator using ANSI escape codes. Unlike a CLI, a TUI has components, keyboard navigation, and real-time updates without a browser. Learn how TUIs work and how to build one in TypeScript with TermUI."
