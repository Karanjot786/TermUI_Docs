---
title: "Testing Guide"
description: "How to test TermUI components with @termuijs/testing. Covers unit tests for widgets, integration tests with real keyboard events, testing async data with useAsync, testing global store state, context providers in tests, and snapshot testing with Vitest. Runs headless, no terminal needed."
