...
```ts
import { keyframes } from '@termuijs/motion'
...
```ts
import { add, scale, lerp, distance } from '@termuijs/motion'
import type { Vec2 } from '@termuijs/motion'
...
```ts
import { pathAnimation, sequence } from '@termuijs/motion'
