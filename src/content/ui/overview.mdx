...
description: "@termuijs/ui provides 10 interactive terminal components: Select, MultiSelect, Tabs, Modal, Toast, Tree, Form, CommandPalette, DatePicker, and ColorPicker. Each manages its own keyboard navigation and focus ring. Built on @termuijs/widgets and styled through @termuijs/tss."
